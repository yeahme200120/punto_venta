...
class ModuloSeeder extends Seeder
{
    public function run(): void
    {
        $modulos = [
            ...
            ['nombre' => 'Compras',         'icono' => '🛒', 'orden' => 5,  'activo' => true],
            ['nombre' => 'Proveedores',     'icono' => '🚚', 'orden' => 6,  'activo' => true],
            ['nombre' => 'Ventas',          'icono' => '💰', 'orden' => 7,  'activo' => true],
            ['nombre' => 'Facturacion',     'icono' => '🧾', 'orden' => 8,  'activo' => true],
            ...
            ['nombre' => 'Notificaciones',  'icono' => '🔔', 'orden' => 13, 'activo' => true],
            ['nombre' => 'Impresoras',      'icono' => '🖨️', 'orden' => 14, 'activo' => true],
