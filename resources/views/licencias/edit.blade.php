...
@section('page-title', 'Editar: ' . $licencia->nombre)
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-3xl shadow-lg p-8">
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl font-bold text-slate-800">Editar: {{ $licencia->nombre }}</h2>
            <p class="text-gray-500 mt-2">${{ number_format($licencia->precio, 2) }} · {{ $licencia->dias }} días</p>
        </div>
        ...
        <form action="{{ route('licencias.update', $licencia) }}" method="POST">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $licencia->nombre) }}" required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="dias" value="{{ old('dias', $licencia->dias) }}" required min="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="precio" value="{{ old('precio', $licencia->precio) }}" required min="0" step="0.01"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="max_usuarios" value="{{ old('max_usuarios', $licencia->max_usuarios) }}" required min="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="max_sucursales" value="{{ old('max_sucursales', $licencia->max_sucursales) }}" required min="0"
                ...
                <div>
                    <label class="flex items-center gap-3 cursor-pointer bg-slate-50 p-4 rounded-xl">
                        <input type="checkbox" name="activo" value="1" class="w-5 h-5 text-indigo-600 rounded" {{ $licencia->activo ? 'checked' : '' }}>
                        <span class="text-sm font-medium text-gray-700">Licencia activa</span>
                    </label>
                </div>
            </div>
