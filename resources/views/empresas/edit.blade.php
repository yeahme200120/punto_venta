...
@section('page-title', 'Editar: ' . $empresa->nombre)
@section('breadcrumbs')
    <li>
    ...
    <li>
        <a href="{{ route('empresas.show', $empresa) }}" class="text-gray-500 transition-colors hover:text-indigo-600">
            {{ $empresa->nombre }}
        </a>
    </li>
    <li>
...
<div class="max-w-2xl mx-auto" x-data="logoEditor()" x-init="initEditor">
    ...
    <div class="p-8 bg-white shadow-lg rounded-3xl">
        <div class="mb-8 text-center">
            ...
            <h2 class="text-2xl font-bold text-slate-800">Editar: {{ $empresa->nombre }}</h2>
            <p class="mt-2 text-gray-500">RFC: {{ $empresa->rfc }}</p>
        </div>
            ...
            <div class="space-y-5">
                            ...
                            <div class="relative w-32 h-32 overflow-hidden bg-gray-100 border-2 border-gray-300 rounded-xl">
                                ...
                                <template x-if="!previewUrl">
                                    <div class="flex items-center justify-center w-full h-full">
                                        @if($empresa->logo_url)
                                            <img src="{{ $empresa->logo_url }}" class="object-cover w-full h-full" alt="Logo actual">
                                        @else
                ...
                <div>
                    <label class="flex items-center gap-3 p-4 cursor-pointer bg-slate-50 rounded-xl">
                        <input type="checkbox" name="activo" value="1" class="w-5 h-5 text-indigo-600 rounded" {{ $empresa->activo ? 'checked' : '' }}>
