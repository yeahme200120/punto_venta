...
@section('content')
    <div class="max-w-3xl mx-auto" x-data="empresaForm()" x-init="init">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start">
                            <div class="relative">
                                <div
                                    class="relative w-32 h-32 overflow-hidden bg-gray-100 border-2 border-gray-300 rounded-xl">
                        ...
                        <select name="licencia_id" x-model="licenciaId" @change="calcularFechaFin" required
                            ...
                            @foreach($licencias as $licencia)
                                <option value="{{ $licencia->id }}" data-dias="{{ $licencia->dias }}">
                                    ...
                                    ({{ $licencia->max_usuarios }} usuarios, {{ $licencia->max_sucursales }} sucursales)
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_fin" x-model="fechaFin" required
                                ...
                                :class="{'bg-gray-100': fechaFinAuto}">
        ...
        <div x-show="showCropper" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
            ...
            <div class="w-full max-w-2xl p-6 mx-4 bg-white rounded-2xl">
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" @click="closeCropper" class="px-4 py-2 border rounded-xl hover:bg-gray-50">
                        Cancelar
                    </button>
        ...
        function empresaForm() {
            return {
                ...
                init() {
                    ...
                    this.fechaInicio = '{{ old("fecha_inicio", date("Y-m-d")) }}';
                    this.fechaFin = '{{ old("fecha_fin") }}';

                    if (!this.fechaFin && this.licenciaId && this.fechaInicio) {
                ...
                calcularFechaFin() {
                    ...
                    // 🔥 MÉTODO MANUAL CON UTC (sin dependencias externas)
                    ...
                    this.mensajeAuto = `📅 Vigencia: ${licencia.dias} días (del ${this.fechaInicio} al ${this.fechaFin})`;

                    // Logs para depuración
                    console.log('fechaInicio original:', this.fechaInicio);
                    console.log('Año, mes, día:', year, month, day);
                    console.log('fechaInicioUTC:', fechaInicioUTC.toISOString());
                    console.log('fechaFinUTC:', fechaFinUTC.toISOString());
                    console.log('fechaFin calculada:', this.fechaFin);
                },
