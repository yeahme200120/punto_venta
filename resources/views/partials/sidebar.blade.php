@php
    ...
    function puedeVerMenu($menu, $user) {
        ...
        // Si el menú tiene un permiso definido, verificar que el usuario lo tenga
        ...
        // Para menús sin permiso definido, verificar si tiene hijos con permiso
    ...
    // Obtener módulos con menús optimizados
...
<aside x-data="sidebar()" 
    ...
    <div class="p-4 transition-all duration-300 border-b border-white/20 bg-gradient-to-r from-indigo-800/50 to-transparent">
    ...
    <nav class="flex-1 p-3 space-y-2 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent hover:scrollbar-thumb-white/30">
        @foreach($modulos as $modulo)
            @php
                // Filtrar menús visibles para el usuario
                                ...
                                <div x-data="{ openSubmenu: {{ $isMenuActive ? 'true' : 'false' }} }">
                                    <div @click.stop.prevent="openSubmenu = !openSubmenu"
                                         ...
                                         :class="{
                                             ...
                                             'bg-white text-slate-900 shadow-lg font-semibold': {{ $isMenuActive ? 'true' : 'false' }}
                                         }">
                                        ...
                                        @foreach($hijosVisibles as $hijo)
                                            ...
                                            <a href="{{ url($hijo->ruta) }}" 
                                               ...
                                               :class="{
                                                ...
                                                <span class="w-1 h-1 transition-colors duration-200 rounded-full {{ $isHijoActive ? 'bg-white' : 'bg-blue-300 group-hover:bg-white' }}"></span>
